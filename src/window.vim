...
set tabstop=4
set tags=~/Programming/python/notorius/src/tags
...
set shortmess=aoO
badd +0 Programming/python/notorius/src/window.py
silent! argdel *
edit Programming/python/notorius/src/window.py
...
silent! normal! zE
let s:l = 93 - ((23 * winheight(0) + 24) / 48)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
93
normal! 07l
lcd ~/Programming/python/notorius/src
wincmd w
argglobal
enew
setlocal keymap=
